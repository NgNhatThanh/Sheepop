...
public class AuthFacadeService {
    ...
    public AuthResponseDTO registerUser(RegistrationDTO dto) throws Exception {
    ...
    public AuthResponseDTO oauthLogin(String code, String provider) throws Exception {
