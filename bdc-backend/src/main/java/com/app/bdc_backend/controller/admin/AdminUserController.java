...
public class AdminUserController {
    ...
    public ResponseEntity<?> deleteUser(@RequestBody Map<String, String> body){ // include userId, and reason
        adminUserFacadeService.deleteUser(body.get("userId"), body.get("reason"));
